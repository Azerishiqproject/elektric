          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-gray-400 text-xs sm:text-sm flex items-center gap-2">
                ...
                <a href="tel:+905076080925" className="hover:text-amber-400 transition-colors">+90 507 608 09 25</a>
              </li>
              <li className="text-gray-400 text-xs sm:text-sm flex items-center gap-2">
                <svg className="w-4 h-4 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@mervenurelektirik.com" className="hover:text-amber-400 transition-colors">info@mervenurelektirik.com</a>
              </li>
              <li className="text-gray-400 text-xs sm:text-sm flex items-center gap-2">
                <svg className="w-4 h-4 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
