...
export const metadata: Metadata = {
  title: "Mervenur elektirik - Profesyonel Tesisat Hizmetleri | İstanbul",
  ...
  authors: [{ name: "Mervenur elektirik" }],
  creator: "Mervenur elektirik",
  publisher: "Mervenur elektirik",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    title: "Mervenur elektirik - Profesyonel Tesisat Hizmetleri",
    ...
    siteName: 'Mervenur elektirik',
    images: [
      {
        url: '/img/slider.jpg',
        width: 1200,
        height: 630,
        alt: 'Mervenur elektirik Tesisat Hizmetleri',
      },
    ],
    locale: 'tr_TR',
    type: 'website',
  ...
  icons: {
    ...
    shortcut: '/icon_browser.png',
    apple: '/icon_browser.png',
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LocalBusiness",
              "name": "Mervenur elektirik",
              "description": "İstanbul'da 20 yıllık deneyimle profesyonel tesisat hizmetleri",
              "url": "https://sekaaltyapi.com",
              "telephone": "+905076080925",
              "email": "info@mervenurelektirik.com",
              "address": {
                "@type": "PostalAddress",
